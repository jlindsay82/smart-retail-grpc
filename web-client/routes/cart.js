...
router.get("/cart", function(req, res, next) {
  res.render('cart', {title: 'Smart Retail'})
});


router.get("/cart/createcart", function (req, res, next) {
  var userId = req.query.userId;
  var result;
if (!isNaN(userId)) {
  try {
...
router.get("/cart/getCart", function (req, res, next) {
...
router.get("/cart/addItem", function (req, res, next) {
  var cartId = req.query.cartId;
